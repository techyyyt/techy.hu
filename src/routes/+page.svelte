...
<div class="bg-space font-mono select-none">
	<div class="scale-wrapper">
		<div class="scale-content w-full max-w-7xl">
			...
			<main class="mx-auto max-w-7xl p-8 pt-4">
				<div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
					...
					>
						...
						<p class="mb-2 text-[0.98em]">
							in my free time, i’m collecting old discs & vhs tapes. i love preserving small pieces
							of digital history (◡‿◡)
						</p>
						<p class="mb-2 text-[0.98em]">
					...
					>
						...
						{#if track}
							<div class="flex flex-col items-center">
								...
								<a href={track.url} target="_blank" class="font-bold hover:underline"
									>{track.title}</a
								>
					...
					>
						...
						<div class="grid grid-cols-2 gap-3">
							...
							<button
								...
								on:click={() =>
									window.open('https://discord.com/users/195968823990550528', '_blank')}
							>
