<script lang="ts">
	...
	const skills: [string, string][] = [
		...
		['devicon:css3', 'css'],
		['devicon:git', 'git'],
		['devicon:javascript', 'javascript'],
		['devicon:typescript', 'typescript'],
		['devicon:csharp', 'c#'],
		['devicon:react', 'react'],
		['devicon:postgresql', 'postgresql'],
		['devicon:docker', 'docker'],
		['devicon:tailwindcss', 'tailwind'],
		['devicon:linux', 'linux'],
		['catppuccin:batch', 'batch']
	];
...
<div class="bg-space flex min-h-screen items-center justify-center font-mono select-none">
	<div class="w-full max-w-7xl">
		<header class="p-4 text-center text-white">
			<div>
				...
				<p class="mt-2 text-lg opacity-70">{'welcome to my digital space <3'}</p>
			</div>
		</header>
		...
		<main class="mx-auto p-4 sm:p-6 lg:p-8">
			<div class="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 xl:grid-cols-3">
				<!-- about me -->
				<div class="floating-box bg-card-dark rounded-2xl p-6 text-white">
				...
				<!-- spotify -->
				<div
					class="floating-box bg-card-dark 0 flex flex-col items-center rounded-2xl p-6 text-center text-white"
				>
					<h2 class="mb-4 flex items-center gap-2 text-2xl font-bold">
						<Icon icon="fa6-solid:music" width="24" /> spotify status (^_^♪)
					</h2>
				...
				<!-- projects -->
				<div
					class="floating-box bg-card-gray order-5 rounded-2xl p-6 text-white md:col-span-2 xl:order-4"
				>
					<h2 class="mb-4 flex items-center gap-2 text-2xl font-bold">
				...
				<!-- links -->
				<div class="floating-box bg-card-link order-5 rounded-2xl p-6 text-white md:order-4">
					<h2 class="mb-4 flex items-center gap-2 text-2xl font-bold">
						<Icon icon="mdi:internet" width="24" height="24" /> find me (´• ω •`)ﾉ
					</h2>
